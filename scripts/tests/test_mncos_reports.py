...
class ReportTests(unittest.TestCase):
    def setUp(self):
        ...
        self.link = "example-image-example.rootfs"
        ...
        (self.root / "mncos-kernel-example.config").write_text("CONFIG_DRM=y\n")

    def collect(self, recipes=None):
        collect_image(self.root, self.link, "example", self.output, {"image": "example-image"}, recipes)
